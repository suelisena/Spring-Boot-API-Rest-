package br.com.springboot.digital_innovention_one.controllers;
...
import br.com.springboot.digital_innovention_one.model.Usuario;
import br.com.springboot.digital_innovention_one.repository.UsuarioRepository;
...
public class GreetingsController {
	...
	public String greetingText(@PathVariable String name) {
		return "Projeto Spring Boot API DIO: " + name + "!";
	}
	...
	@GetMapping(value = "listatodos") /* Nosso primeiro m̩todo de API */
